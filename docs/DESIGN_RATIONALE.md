# Sage Invest: design rationale and FAQ

This document explains how the code is organized, defines the key terms, and answers the twenty questions we asked ourselves hardest while building: why sampling, why knowledge gates products, what the out of sample gap means, and where the method's limits are. It complements the README (setup, provenance, verification) and the AI Use Disclosure.
